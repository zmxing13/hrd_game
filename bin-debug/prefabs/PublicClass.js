...
var PublicClass = (function (_super) {
    ...
    */
     ...
     * 验证手机号是否符合标准
     */
    PublicClass.prototype.validationPhone = function (_phoneNum) {
        var phoneNum = _phoneNum;
        var re = /^[0-9]/g;
        var reg = re.test(phoneNum);
        var returnStr;
        returnStr = 'pass'; //合格
     ...
     * 这里交换类型1的数据；一对一交换数据
     */
    PublicClass.prototype.typeOneHander = function (totalArr, pointA, pointB) {
        var tempHead, tempBody, c;
    ...
    * 这里交换类型2的数据；二对二交换数据
    */
    PublicClass.prototype.typeTwoHander = function (totalArr, pointA, pointB, directionStr) {
        //  console.log("更改前的totalArr："+totalArr+"更改前PointA:"+pointA+"更改前PointB:"+pointB);
        var tempNumA = 0, tempNumB = 0, tempNumC = 0, tempNumD = 0, numA1 = pointA[0][1], numA2 = pointA[0][0], numB1 = pointA[1][1], numB2 = pointA[1][0];
        if (directionStr == "top" || directionStr == "low") {
            var numC1 = pointB[1], numC2 = pointB[0];
        }
        if (directionStr == "left" || directionStr == "right") {
            var numC1 = pointB[0][1], numC2 = pointB[0][0], numD1 = pointB[1][1], numD2 = pointB[1][0];
        }
        switch (directionStr) {
            case "top":
                // console.log("run top");
     ...
     * 这里交换类型3的数据；二对二交换数据
     */
    PublicClass.prototype.typeThreeHander = function (totalArr, pointA, pointB, directionStr) {
        //  console.log("更改前的totalArr："+totalArr+"更改前PointA:"+pointA+"更改前PointB:"+pointB);
        var tempNumA = 0, tempNumB = 0, tempNumC = 0, tempNumD = 0, numA1 = pointA[0][1], numA2 = pointA[0][0], numB1 = pointA[1][1], numB2 = pointA[1][0];
        if (directionStr == "left" || directionStr == "right") {
            var numC1 = pointB[1], numC2 = pointB[0];
    ...
    * 这里交换类型4的数据；四对二交换数据
    */
    PublicClass.prototype.typeFourHander = function (totalArr, pointA, pointB, directionStr) {
        var tempNumA = 0, tempNumB = 0, tempNumC = 0, tempNumD = 0, tempNumE = 0, tempNumF = 0, numA1 = pointA[0][1], numA2 = pointA[0][0], numB1 = pointA[1][1], numB2 = pointA[1][0], numC1 = pointA[2][1], numC2 = pointA[2][0], numD1 = pointA[3][1], numD2 = pointA[3][0], numE1 = pointB[0][1], numE2 = pointB[0][0], numF1 = pointB[1][1], numF2 = pointB[1][0];
        tempNumA = totalArr[numA1][numA2];
        tempNumB = totalArr[numB1][numB2];
        tempNumC = totalArr[numC1][numC2];
        tempNumD = totalArr[numD1][numD2];
     ...
     *
     */
    PublicClass.prototype.typeFiveHander = function (totalArr, pointA, pointB, directionStr) {
        //  console.log("更改前的totalArr："+totalArr+"更改前PointA:"+pointA+"更改前PointB:"+pointB);
        var tempNumA = 0, tempNumB = 0, tempNumC = 0, tempNumD = 0, numA1 = pointA[0][1], numA2 = pointA[0][0], numB1 = pointA[1][1], numB2 = pointA[1][0], numC1 = pointA[2][1], numC2 = pointA[2][0];
        if (directionStr == "top" || directionStr == "low") {
            var numD1 = pointB[1], numD2 = pointB[0];
            tempNumA = totalArr[numA1][numA2];
            tempNumB = totalArr[numB1][numB2];
            tempNumC = totalArr[numC1][numC2];
            tempNumD = totalArr[numD1][numD2];
    ...
    *
    */
    PublicClass.prototype.typeSixeHander = function (totalArr, pointA, pointB, directionStr) {
        //   console.log("更改前的totalArr："+totalArr+"更改前PointA:"+pointA+"更改前PointB:"+pointB);
        //   console.log("更改前PointA:"+pointA+"更改前PointB:"+pointB);
        if (directionStr == "left" || directionStr == "right") {
            var tempNumA = 0, tempNumB = 0, tempNumC = 0, tempNumD = 0;
            var numA1 = pointA[0][1], numA2 = pointA[0][0], numB1 = pointA[1][1], numB2 = pointA[1][0], numC1 = pointA[2][1], numC2 = pointA[2][0], numD1 = pointB[1], numD2 = pointB[0];
        }
        if (directionStr == "top" || directionStr == "low") {
            var tempNumA = 0, tempNumB = 0, tempNumC = 0, tempNumD = 0, tempNumE = 0, tempNumF = 0, numA1 = pointA[0][1], numA2 = pointA[0][0], numB1 = pointA[1][1], numB2 = pointA[1][0], numC1 = pointA[2][1], numC2 = pointA[2][0], numD1 = pointB[0][1], numD2 = pointB[0][0], numE1 = pointB[1][1], numE2 = pointB[1][0], numF1 = pointB[2][1], numF2 = pointB[2][0];
        }
        switch (directionStr) {
            case "top":
                tempNumA = totalArr[numA1][numA2];
    ...
    //计算两点之间距离
    PublicClass.prototype.twoPointDistance = function (x1, y1, x2, y2) {
        var sum;
