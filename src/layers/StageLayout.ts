// 舞台布局
class StageLayout extends egret.DisplayObjectContainer {
    public constructor() {
        super();
		...
		private _tempBg:egret.Sprite;
		private ImgscopeX:egret.Bitmap;
		private ImglongitudinalY:egret.Bitmap;

    	private img_bg:egret.Bitmap;		//舞台背景
		private restBtn:egret.Bitmap;		//刷新按钮
		...
		private _publicClass:PublicClass=new PublicClass();	//交换AB数据
	...
	private init_Sprite(): void {
		this._stagePointArr=new Array<any>();
		this._copyStagePointArr=new Array<any>();
